...
router.post(
  ...
  [
    ...
    body("url")
      ...
      .isEmpty()
      .withMessage(
        util.format(responseStatus.http.validate.is_empty.error_message, "url")
      ),
    body("url")
      .matches(constant.MATCH_TYPE_YOUTUBE_URL)
      .withMessage(
        util.format(
          responseStatus.http.validate.wrong_format_youtube_url.error_message,
          "url"
        )
      ),
  ],
  validate,
  shareController.shareMovie
);
